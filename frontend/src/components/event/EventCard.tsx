...
import { ChevronsUp, ChevronsDown, DollarSign } from "lucide-react";
...
export default function EventCard({
  ...
  const handleConfirmTrade = async () => {
    if (!selectedOutcome || !tradeAmount) return;
          ...
          {isInTradingMode ? (
            ...
            <div className="space-y-3 flex-1">
                ...
                <input
                  ...
                  onBlur={(e) => {
                    ...
                    if (value && !isNaN(parseFloat(value))) {
                      setTradeAmount(formatValue(parseFloat(value)));
                    }
                  }}
                  onKeyDown={(e) => {
                    if (
              ...
              <button
                ...
                disabled={
                  isLoading || !tradeAmount || parseFloat(tradeAmount) <= 0
                }
              ...
              >
                {isLoading ? (
                  ...
                  <div className="text-center">
                    <div>
                      Buy {selectedOutcome.type === "yes" ? "Yes" : "No"}
                    </div>
                    <div className="text-xs opacity-90">
                      to win ${calculateWinnings(tradeAmount)}
                    </div>
                  </div>
                )}
              </button>
            ...
            <>
              ...
              {isBinaryMarket && yesOutcome && noOutcome && (
                <div className="grid grid-cols-2 gap-2 mt-auto mb-2">
                  ...
                  >
                    Buy Yes <ChevronsUp className="h-4 w-4" />
                  </button>
                  <button
                    onClick={(e) => {
                      e.stopPropagation();
                  ...
                  >
                    Buy No <ChevronsDown className="h-4 w-4" />
                  </button>
                </div>
              )}
            </>
