import type { ChartSettings } from '@/app/(platform)/event/[slug]/_components/EventChartControls'
import { defaultChartSettings } from '@/app/(platform)/event/[slug]/_components/EventChartControls'
