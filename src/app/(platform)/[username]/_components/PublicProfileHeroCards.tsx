...
import type { ProfileForCards } from '@/app/(platform)/_components/ProfileOverviewCard'
...
import ProfileOverviewCard from '@/app/(platform)/_components/ProfileOverviewCard'
