...
import EventCardFooter from '@/app/(platform)/(home)/_components/EventCardFooter'
import EventCardHeader from '@/app/(platform)/(home)/_components/EventCardHeader'
import EventCardMarketsList from '@/app/(platform)/(home)/_components/EventCardMarketsList'
